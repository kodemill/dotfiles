# Generated by Powerlevel10k configuration wizard on 2019-12-30 at 00:28 CET.
# Based on romkatv/powerlevel10k/config/p10k-lean.zsh, checksum 00551.
# Wizard options: awesome-fontconfig + powerline + python, large icons, lean, time,
# 2 lines, dotted, left frame, darkest, compact, many icons, fluent,
